...
// logError() method is generic helper for logging an error message
...
// serverErrorResponse() method will be used when app encountered problem in runtime
...
// Note that errors parameter here has the type map[string]string, which is exactly
// the same as the errors map contained in Validation type.
