...
// ./templates directory in the templateFS embedded file system varieble.
// ⬇️⬇️⬇️
...
// and the sender information for your emails (the name and address you want the email to be form,
...
func New(host string, port int, username, password, sender string) Mailer {
	...
	// also configure this to use a 5-seccond timeout whenever we send an email.
...
// Define a Send() method on the Mailer type. This takes the recipient email address as
// the first parameter, the name of the file containing the templates, and any dynamic data for
...
func (m Mailer) Send(recipient, templateFile string, data interface{}) error {
	...
	// method to set the HTML body, It's important to note thet AddAlternative() should
	...
	for i := 1; i <= 3; i++ {
		...
		// If didnt work sleep for a short time and retry
