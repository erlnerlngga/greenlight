...
// Define a custom Logger type. This holds the output destination that the log entries will be
// written to, the minimum severity level that log entries will be written for, plus a mutex
...
// Declare some helper methods for writing log entries at the different levels. Notice that these
// all accept a map as the seccond parameter which can contain any arbitrary 'properties' that you
...
func (l *Logger) print(level Level, message string, properties map[string]string) (int, error) {
	...
	// If we don't do this, it's possible that the text for two or more log entries will be
...
// We also implement a Write() method on our Logger type so that it satisfies the io.Writer
